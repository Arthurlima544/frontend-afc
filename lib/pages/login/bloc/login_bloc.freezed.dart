...
class _Validate implements LoginEvent {
...
@override
String toString() {
  return 'LoginEvent.validate(type: $type, value: $value)';
}
...
/// @nodoc
abstract mixin class _$ValidateCopyWith<$Res> implements $LoginEventCopyWith<$Res> {
...
mixin _$LoginState {
 ...
 String get email; String get password; String? get emailError; String? get passwordError; bool get isSubmitting; bool get isSuccess; String? get submissionError;
...
@override
int get hashCode => Object.hash(runtimeType,email,password,emailError,passwordError,isSubmitting,isSuccess,submissionError);

@override
String toString() {
  return 'LoginState(email: $email, password: $password, emailError: $emailError, passwordError: $passwordError, isSubmitting: $isSubmitting, isSuccess: $isSuccess, submissionError: $submissionError)';
}
...
@useResult
$Res call({
 String email, String password, String? emailError, String? passwordError, bool isSubmitting, bool isSuccess, String? submissionError
});
...
/// Create a copy of LoginState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,Object? emailError = freezed,Object? passwordError = freezed,Object? isSubmitting = null,Object? isSuccess = null,Object? submissionError = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password,  String? emailError,  String? passwordError,  bool isSubmitting,  bool isSuccess,  String? submissionError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginState() when $default != null:
return $default(_that.email,_that.password,_that.emailError,_that.passwordError,_that.isSubmitting,_that.isSuccess,_that.submissionError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password,  String? emailError,  String? passwordError,  bool isSubmitting,  bool isSuccess,  String? submissionError)  $default,) {final _that = this;
switch (_that) {
case _LoginState():
return $default(_that.email,_that.password,_that.emailError,_that.passwordError,_that.isSubmitting,_that.isSuccess,_that.submissionError);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password,  String? emailError,  String? passwordError,  bool isSubmitting,  bool isSuccess,  String? submissionError)?  $default,) {final _that = this;
switch (_that) {
case _LoginState() when $default != null:
return $default(_that.email,_that.password,_that.emailError,_that.passwordError,_that.isSubmitting,_that.isSuccess,_that.submissionError);case _:
  return null;
...
class _LoginState extends LoginState {
  const _LoginState({this.email = '', this.password = '', this.emailError, this.passwordError, this.isSubmitting = false, this.isSuccess = false, this.submissionError}): super._();
...
/// Create a copy of LoginState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? emailError = freezed,Object? passwordError = freezed,Object? isSubmitting = null,Object? isSuccess = null,Object? submissionError = freezed,}) {
